// Modifs - en attendant mieux - pour supporter IE9. zygotine. Juin 2012
    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function constructCanvas() {
            function makeCanvas(width, height) {
                ...
                c.width = width;
                c.height = height;
                if ($.browser.msie && (parseInt($.browser.version) < 9)) // Modif zygotine
        ...
        function insertLegend() {
            ...
            if (options.legend.container != null)
                ...
                var legend = $('<div class="legend" style="border:1px solid black">' + table.replace('style="', 'style="position:absolute;' + pos +';') + '</div>').appendTo(placeholder);
